...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k22118,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k22118,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__22123){
var vec__22124 = p__22123;
var k__5364__auto__ = cljs.core.nth.call(null,vec__22124,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__22124,(1),null);
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22117){
var self__ = this;
var G__22117__$1 = this;
return (new cljs.core.RecordIter((0),G__22117__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22119,other22120){
var self__ = this;
var this22119__$1 = this;
return (((!((other22120 == null)))) && ((((this22119__$1.constructor === other22120.constructor)) && (((cljs.core._EQ_.call(null,this22119__$1.pre,other22120.pre)) && (cljs.core._EQ_.call(null,this22119__$1.__extmap,other22120.__extmap)))))));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k22118){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k22118);

}
}));

(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__22117){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__22128 = cljs.core.keyword_identical_QMARK_;
var expr__22129 = k__5349__auto__;
if(cljs.core.truth_(pred__22128.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__22129))){
return (new schema.spec.leaf.LeafSpec(G__22117,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__22117),null));
}
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__22117){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__22117,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__22121){
var extmap__5382__auto__ = (function (){var G__22131 = cljs.core.dissoc.call(null,G__22121,new cljs.core.Keyword(null,"pre","pre",2118456869));
if(cljs.core.record_QMARK_.call(null,G__22121)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__22131);
} else {
return G__22131;
}
})();
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__22121),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
