...
var G__22068 = cljs.core.first.call(null,e);
...
if(cljs.core.not_any_QMARK_.call(null,(function (p1__22070_SHARP_){
return ((cljs.core.vector_QMARK_.call(null,p1__22070_SHARP_)) && (cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__22070_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k22072,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k22072,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__22077){
var vec__22078 = p__22077;
var k__5364__auto__ = cljs.core.nth.call(null,vec__22078,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__22078,(1),null);
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22071){
var self__ = this;
var G__22071__$1 = this;
return (new cljs.core.RecordIter((0),G__22071__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22073,other22074){
var self__ = this;
var this22073__$1 = this;
return (((!((other22074 == null)))) && ((((this22073__$1.constructor === other22074.constructor)) && (((cljs.core._EQ_.call(null,this22073__$1.pre,other22074.pre)) && (((cljs.core._EQ_.call(null,this22073__$1.konstructor,other22074.konstructor)) && (((cljs.core._EQ_.call(null,this22073__$1.elements,other22074.elements)) && (((cljs.core._EQ_.call(null,this22073__$1.on_error,other22074.on_error)) && (cljs.core._EQ_.call(null,this22073__$1.__extmap,other22074.__extmap)))))))))))));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k22072){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k22072);

}
}));

(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__22071){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__22082 = cljs.core.keyword_identical_QMARK_;
var expr__22083 = k__5349__auto__;
if(cljs.core.truth_(pred__22082.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__22083))){
return (new schema.spec.collection.CollectionSpec(G__22071,self__.konstructor,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22082.call(null,new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),expr__22083))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__22071,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22082.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__22083))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,G__22071,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22082.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__22083))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,G__22071,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__22071),null));
}
}
}
}
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__22071){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,self__.on_error,G__22071,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__22075){
var extmap__5382__auto__ = (function (){var G__22085 = cljs.core.dissoc.call(null,G__22075,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530));
if(cljs.core.record_QMARK_.call(null,G__22075)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__22085);
} else {
return G__22085;
}
})();
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__22075),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557).cljs$core$IFn$_invoke$arity$1(G__22075),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__22075),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__22075),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
...
var len__5766__auto___22089 = arguments.length;
var i__5767__auto___22090 = (0);
while(true){
if((i__5767__auto___22090 < len__5766__auto___22089)){
args__5772__auto__.push((arguments[i__5767__auto___22090]));

var G__22091 = (i__5767__auto___22090 + (1));
i__5767__auto___22090 = G__22091;
continue;
} else {
}
break;
...
/** @this {Function} */
(schema.spec.collection.optional.cljs$lang$applyTo = (function (seq22088){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq22088));
}));
