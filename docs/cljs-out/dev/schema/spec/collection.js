...
var G__20569 = cljs.core.first.call(null,e);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20569__$1)].join('')));
...
if(cljs.core.not_any_QMARK_.call(null,(function (p1__20571_SHARP_){
return ((cljs.core.vector_QMARK_.call(null,p1__20571_SHARP_)) && (cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__20571_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k20573,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k20573,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__20578){
var vec__20579 = p__20578;
var k__5364__auto__ = cljs.core.nth.call(null,vec__20579,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__20579,(1),null);
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20572){
var self__ = this;
var G__20572__$1 = this;
return (new cljs.core.RecordIter((0),G__20572__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this20574,other20575){
var self__ = this;
var this20574__$1 = this;
return (((!((other20575 == null)))) && ((((this20574__$1.constructor === other20575.constructor)) && (((cljs.core._EQ_.call(null,this20574__$1.pre,other20575.pre)) && (((cljs.core._EQ_.call(null,this20574__$1.konstructor,other20575.konstructor)) && (((cljs.core._EQ_.call(null,this20574__$1.elements,other20575.elements)) && (((cljs.core._EQ_.call(null,this20574__$1.on_error,other20575.on_error)) && (cljs.core._EQ_.call(null,this20574__$1.__extmap,other20575.__extmap)))))))))))));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k20573){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k20573);

}
}));

(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__20572){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__20583 = cljs.core.keyword_identical_QMARK_;
var expr__20584 = k__5349__auto__;
if(cljs.core.truth_(pred__20583.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__20584))){
return (new schema.spec.collection.CollectionSpec(G__20572,self__.konstructor,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20583.call(null,new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),expr__20584))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__20572,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20583.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__20584))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,G__20572,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20583.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__20584))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,G__20572,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__20572),null));
}
}
}
}
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__20572){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.konstructor,self__.elements,self__.on_error,G__20572,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__20576){
var extmap__5382__auto__ = (function (){var G__20586 = cljs.core.dissoc.call(null,G__20576,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530));
if(cljs.core.record_QMARK_.call(null,G__20576)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__20586);
} else {
return G__20586;
}
})();
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__20576),new cljs.core.Keyword(null,"konstructor","konstructor",-1422324557).cljs$core$IFn$_invoke$arity$1(G__20576),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__20576),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__20576),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
...
var len__5766__auto___20590 = arguments.length;
var i__5767__auto___20591 = (0);
while(true){
if((i__5767__auto___20591 < len__5766__auto___20590)){
args__5772__auto__.push((arguments[i__5767__auto___20591]));

var G__20592 = (i__5767__auto___20591 + (1));
i__5767__auto___20591 = G__20592;
continue;
} else {
}
break;
...
/** @this {Function} */
(schema.spec.collection.optional.cljs$lang$applyTo = (function (seq20589){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20589));
}));
