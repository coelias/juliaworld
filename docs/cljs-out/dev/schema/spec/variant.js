...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k22099,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k22099,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__22104){
var vec__22105 = p__22104;
var k__5364__auto__ = cljs.core.nth.call(null,vec__22105,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__22105,(1),null);
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22100,other22101){
var self__ = this;
var this22100__$1 = this;
return (((!((other22101 == null)))) && ((((this22100__$1.constructor === other22101.constructor)) && (((cljs.core._EQ_.call(null,this22100__$1.pre,other22101.pre)) && (((cljs.core._EQ_.call(null,this22100__$1.options,other22101.options)) && (((cljs.core._EQ_.call(null,this22100__$1.err_f,other22101.err_f)) && (((cljs.core._EQ_.call(null,this22100__$1.post,other22101.post)) && (cljs.core._EQ_.call(null,this22100__$1.__extmap,other22101.__extmap)))))))))))));
}));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k22099){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k22099);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__22098){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__22109 = cljs.core.keyword_identical_QMARK_;
var expr__22110 = k__5349__auto__;
if(cljs.core.truth_(pred__22109.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__22110))){
return (new schema.spec.variant.VariantSpec(G__22098,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22109.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__22110))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__22098,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22109.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__22110))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__22098,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22109.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__22110))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__22098,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__22098),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__22098){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__22098,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__22102){
var extmap__5382__auto__ = (function (){var G__22112 = cljs.core.dissoc.call(null,G__22102,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687));
if(cljs.core.record_QMARK_.call(null,G__22102)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__22112);
} else {
return G__22112;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__22102),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__22102),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__22102),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__22102),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
