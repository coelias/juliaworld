...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k20597,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k20597,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__20602){
var vec__20603 = p__20602;
var k__5364__auto__ = cljs.core.nth.call(null,vec__20603,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__20603,(1),null);
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this20598,other20599){
var self__ = this;
var this20598__$1 = this;
return (((!((other20599 == null)))) && ((((this20598__$1.constructor === other20599.constructor)) && (((cljs.core._EQ_.call(null,this20598__$1.pre,other20599.pre)) && (((cljs.core._EQ_.call(null,this20598__$1.options,other20599.options)) && (((cljs.core._EQ_.call(null,this20598__$1.err_f,other20599.err_f)) && (((cljs.core._EQ_.call(null,this20598__$1.post,other20599.post)) && (cljs.core._EQ_.call(null,this20598__$1.__extmap,other20599.__extmap)))))))))))));
}));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k20597){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k20597);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__20596){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__20607 = cljs.core.keyword_identical_QMARK_;
var expr__20608 = k__5349__auto__;
if(cljs.core.truth_(pred__20607.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__20608))){
return (new schema.spec.variant.VariantSpec(G__20596,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20607.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__20608))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__20596,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20607.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__20608))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__20596,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20607.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__20608))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__20596,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__20596),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__20596){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__20596,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__20600){
var extmap__5382__auto__ = (function (){var G__20610 = cljs.core.dissoc.call(null,G__20600,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687));
if(cljs.core.record_QMARK_.call(null,G__20600)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__20610);
} else {
return G__20610;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__20600),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__20600),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__20600),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__20600),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
