...
var len__5766__auto___21738 = arguments.length;
var i__5767__auto___21739 = (0);
while(true){
if((i__5767__auto___21739 < len__5766__auto___21738)){
args__5772__auto__.push((arguments[i__5767__auto___21739]));

var G__21740 = (i__5767__auto___21739 + (1));
i__5767__auto___21739 = G__21740;
continue;
} else {
}
break;
...
})(),(function (){var iter__5520__auto__ = (function schema$utils$iter__21728(s__21729){
return (new cljs.core.LazySeq(null,(function (){
var s__21729__$1 = s__21729;
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,s__21729__$1);
if(temp__5804__auto__){
var s__21729__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__21729__$2)){
var c__5518__auto__ = cljs.core.chunk_first.call(null,s__21729__$2);
var size__5519__auto__ = cljs.core.count.call(null,c__5518__auto__);
var b__21731 = cljs.core.chunk_buffer.call(null,size__5519__auto__);
if((function (){var i__21730 = (0);
while(true){
if((i__21730 < size__5519__auto__)){
var vec__21732 = cljs.core._nth.call(null,c__5518__auto__,i__21730);
var k = cljs.core.nth.call(null,vec__21732,(0),null);
var v = cljs.core.nth.call(null,vec__21732,(1),null);
if(cljs.core.truth_(v)){
cljs.core.chunk_append.call(null,b__21731,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));

var G__21741 = (i__21730 + (1));
i__21730 = G__21741;
continue;
} else {
var G__21742 = (i__21730 + (1));
i__21730 = G__21742;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21731),schema$utils$iter__21728.call(null,cljs.core.chunk_rest.call(null,s__21729__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21731),null);
}
} else {
var vec__21735 = cljs.core.first.call(null,s__21729__$2);
var k = cljs.core.nth.call(null,vec__21735,(0),null);
var v = cljs.core.nth.call(null,vec__21735,(1),null);
if(cljs.core.truth_(v)){
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null),schema$utils$iter__21728.call(null,cljs.core.rest.call(null,s__21729__$2)));
} else {
var G__21743 = cljs.core.rest.call(null,s__21729__$2);
s__21729__$1 = G__21743;
continue;
}
}
} else {
...
/** @this {Function} */
(schema.utils.assoc_when.cljs$lang$applyTo = (function (seq21726){
...
var args__5772__auto__ = [];
var len__5766__auto___21746 = arguments.length;
var i__5767__auto___21747 = (0);
while(true){
if((i__5767__auto___21747 < len__5766__auto___21746)){
args__5772__auto__.push((arguments[i__5767__auto___21747]));

var G__21748 = (i__5767__auto___21747 + (1));
i__5767__auto___21747 = G__21748;
continue;
} else {
}
break;
...
/** @this {Function} */
(schema.utils.format_STAR_.cljs$lang$applyTo = (function (seq21744){
var G__21745 = cljs.core.first.call(null,seq21744);
var seq21744__$1 = cljs.core.next.call(null,seq21744);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21745,seq21744__$1);
}));
...
var vec__21750 = cljs.core.re_matches.call(null,/#object\[(.*)\]/,cljs.core.pr_str.call(null,f));
...
(schema.utils.ErrorContainer.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k21755,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k21755,else__5343__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5363__auto__,p__21760){
var vec__21761 = p__21760;
var k__5364__auto__ = cljs.core.nth.call(null,vec__21761,(0),null);
var v__5365__auto__ = cljs.core.nth.call(null,vec__21761,(1),null);
...
(schema.utils.ErrorContainer.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21754){
var self__ = this;
var G__21754__$1 = this;
return (new cljs.core.RecordIter((0),G__21754__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21756,other21757){
var self__ = this;
var this21756__$1 = this;
return (((!((other21757 == null)))) && ((((this21756__$1.constructor === other21757.constructor)) && (((cljs.core._EQ_.call(null,this21756__$1.error,other21757.error)) && (cljs.core._EQ_.call(null,this21756__$1.__extmap,other21757.__extmap)))))));
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k21755){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k21755);

}
}));

(schema.utils.ErrorContainer.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__21754){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__21765 = cljs.core.keyword_identical_QMARK_;
var expr__21766 = k__5349__auto__;
if(cljs.core.truth_(pred__21765.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__21766))){
return (new schema.utils.ErrorContainer(G__21754,self__.__meta,self__.__extmap,null));
} else {
return (new schema.utils.ErrorContainer(self__.error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5349__auto__,G__21754),null));
}
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__21754){
var self__ = this;
var this__5339__auto____$1 = this;
return (new schema.utils.ErrorContainer(self__.error,G__21754,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.utils.map__GT_ErrorContainer = (function schema$utils$map__GT_ErrorContainer(G__21758){
var extmap__5382__auto__ = (function (){var G__21768 = cljs.core.dissoc.call(null,G__21758,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_.call(null,G__21758)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__21768);
} else {
return G__21768;
}
})();
return (new schema.utils.ErrorContainer(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__21758),null,cljs.core.not_empty.call(null,extmap__5382__auto__),null));
});
