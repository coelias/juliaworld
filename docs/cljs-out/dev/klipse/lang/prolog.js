...
var f__17204__auto__ = (function (){var obj20575 = obj__17203__auto__;
var k20576 = "create";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj20575,k20576)){
return (obj20575[k20576]);
} else {
return null;
}
})();
...
var f__17204__auto__ = (function (){var obj20577 = obj__17203__auto__;
var k20578 = "consult";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj20577,k20578)){
return (obj20577[k20578]);
} else {
return null;
}
})();
...
var vec__20580_20583 = klipse.lang.prolog.consult_STAR_.call(null,exp);
var status_20584 = cljs.core.nth.call(null,vec__20580_20583,(0),null);
var res_20585 = cljs.core.nth.call(null,vec__20580_20583,(1),null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_20584)){
cljs.core.async.put_BANG_.call(null,c,res_20585);
} else {
cljs.core.async.put_BANG_.call(null,c,"Rules are valid.");
}
}catch (e20579){var o_20586 = e20579;
cljs.core.async.put_BANG_.call(null,c,cljs.core.str.cljs$core$IFn$_invoke$arity$1(o_20586));
}
return c;
});
...
var my_session = cljs.core.deref.call(null,klipse.lang.prolog.session);
var res = (function (){var obj__17203__auto__ = my_session;
var f__17204__auto__ = (function (){var obj20587 = obj__17203__auto__;
var k20588 = "query";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj20587,k20588)){
return (obj20587[k20588]);
} else {
return null;
}
})();
...
var f__17204__auto__ = (function (){var obj20589 = obj__17203__auto__;
var k20590 = "answer";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj20589,k20590)){
return (obj20589[k20590]);
} else {
return null;
}
})();
...
var G__20591 = ans;
if(cljs.core._EQ_.call(null,false,G__20591)){
if((num_solutions === (0))){
...
if(cljs.core._EQ_.call(null,null,G__20591)){
...
var f__17204__auto____$1 = (function (){var obj20594 = obj__17203__auto____$1;
var k20595 = "format_answer";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj20594,k20595)){
return (obj20594[k20595]);
} else {
return null;
}
})();
...
var vec__20598_20601 = klipse.lang.prolog.query_STAR_.call(null,exp);
var status_20602 = cljs.core.nth.call(null,vec__20598_20601,(0),null);
var res_20603 = cljs.core.nth.call(null,vec__20598_20601,(1),null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_20602)){
cljs.core.async.put_BANG_.call(null,c,res_20603);
} else {
klipse.lang.prolog.answer_STAR_.call(null,(0),(0),(function (p1__20596_SHARP_){
return cljs.core.async.put_BANG_.call(null,c,p1__20596_SHARP_);
}));
}
}catch (e20597){var o_20604 = e20597;
cljs.core.async.put_BANG_.call(null,c,cljs.core.str.cljs$core$IFn$_invoke$arity$1(o_20604));
}
return c;
});
