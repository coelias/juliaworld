...
try{var config = cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stdio","stdio",-1570777132),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"write","write",-1857649168),(function (p1__33019_SHARP_){
return cljs.core.async.put_BANG_.call(null,c,p1__33019_SHARP_);
})], null)], null));
var input = "";
var exitCode = (function (){var obj__20025__auto__ = JSCPP;
var f__20026__auto__ = (function (){var obj33021 = obj__20025__auto__;
var k33022 = "run";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj33021,k33022)){
return (obj33021[k33022]);
} else {
return null;
}
})();
...
var vec__33023 = klipse.lang.cpp.eval_in_chan.call(null,s,c);
var status = cljs.core.nth.call(null,vec__33023,(0),null);
var res = cljs.core.nth.call(null,vec__33023,(1),null);
var G__33026_33027 = status;
var G__33026_33028__$1 = (((G__33026_33027 instanceof cljs.core.Keyword))?G__33026_33027.fqn:null);
switch (G__33026_33028__$1) {
case "ok":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33026_33028__$1)].join('')));
