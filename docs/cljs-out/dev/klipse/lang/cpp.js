...
try{var config = cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stdio","stdio",-1570777132),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"write","write",-1857649168),(function (p1__31506_SHARP_){
return cljs.core.async.put_BANG_.call(null,c,p1__31506_SHARP_);
})], null)], null));
var input = "";
var exitCode = (function (){var obj__17203__auto__ = JSCPP;
var f__17204__auto__ = (function (){var obj31508 = obj__17203__auto__;
var k31509 = "run";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj31508,k31509)){
return (obj31508[k31509]);
} else {
return null;
}
})();
return f__17204__auto__.call(obj__17203__auto__,s,input,config);
})();
...
var vec__31510 = klipse.lang.cpp.eval_in_chan.call(null,s,c);
var status = cljs.core.nth.call(null,vec__31510,(0),null);
var res = cljs.core.nth.call(null,vec__31510,(1),null);
var G__31513_31514 = status;
var G__31513_31515__$1 = (((G__31513_31514 instanceof cljs.core.Keyword))?G__31513_31514.fqn:null);
switch (G__31513_31515__$1) {
case "ok":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31513_31515__$1)].join('')));
