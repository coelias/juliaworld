...
try{var config = cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stdio","stdio",-1570777132),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"write","write",-1857649168),(function (p1__28820_SHARP_){
return cljs.core.async.put_BANG_.call(null,c,p1__28820_SHARP_);
})], null)], null));
var input = "";
var exitCode = (function (){var obj__17203__auto__ = JSCPP;
var f__17204__auto__ = (function (){var obj28822 = obj__17203__auto__;
var k28823 = "run";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj28822,k28823)){
return (obj28822[k28823]);
} else {
return null;
}
})();
...
var vec__28824 = klipse.lang.cpp.eval_in_chan.call(null,s,c);
var status = cljs.core.nth.call(null,vec__28824,(0),null);
var res = cljs.core.nth.call(null,vec__28824,(1),null);
var G__28827_28828 = status;
var G__28827_28829__$1 = (((G__28827_28828 instanceof cljs.core.Keyword))?G__28827_28828.fqn:null);
switch (G__28827_28829__$1) {
case "ok":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28827_28829__$1)].join('')));
