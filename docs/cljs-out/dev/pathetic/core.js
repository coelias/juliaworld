...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__20846_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__20846_SHARP_),cljs.core.second.call(null,p1__20846_SHARP_));
}),cljs.core.map.call(null,(function (p1__20847_SHARP_,p2__20848_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__20847_SHARP_,p2__20848_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__20849 = cljs.core.first.call(null,path_pieces);
switch (G__20849) {
case "":
...
var G__20851 = cljs.core.first.call(null,path_pieces);
...
var G__20853 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__20853)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__20853)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__20853)){
return path_pieces;
} else {
...
var curr = first__20862;
var remainder = seq__20861__$1;
var pred__20863 = cljs.core._EQ_;
var expr__20864 = curr;
if(cljs.core.truth_(pred__20863.call(null,null,expr__20864))){
return result;
} else {
if(cljs.core.truth_(pred__20863.call(null,"",expr__20864))){
var G__20866 = result;
var G__20867 = remainder;
result = G__20866;
remaining_path = G__20867;
continue;
} else {
if(cljs.core.truth_(pred__20863.call(null,".",expr__20864))){
var G__20868 = result;
var G__20869 = remainder;
result = G__20868;
remaining_path = G__20869;
continue;
} else {
if(cljs.core.truth_(pred__20863.call(null,"..",expr__20864))){
var G__20870 = pathetic.core.up_dir.call(null,result);
var G__20871 = remainder;
result = G__20870;
remaining_path = G__20871;
continue;
} else {
var G__20872 = cljs.core.conj.call(null,result,curr);
var G__20873 = remainder;
result = G__20872;
remaining_path = G__20873;
continue;
}
}
}
...
var expr__20878 = curr;
if(cljs.core.truth_(pred__20877.call(null,null,expr__20878))){
return suffix;
} else {
if(cljs.core.truth_(pred__20877.call(null,"",expr__20878))){
var G__20880 = suffix;
var G__20881 = cljs.core.rest.call(null,remainder);
suffix = G__20880;
remainder = G__20881;
continue;
} else {
if(cljs.core.truth_(pred__20877.call(null,".",expr__20878))){
var G__20882 = suffix;
var G__20883 = cljs.core.rest.call(null,remainder);
suffix = G__20882;
remainder = G__20883;
continue;
} else {
if(cljs.core.truth_(pred__20877.call(null,"..",expr__20878))){
var G__20884 = cljs.core.conj.call(null,suffix,"..");
var G__20885 = cljs.core.rest.call(null,remainder);
suffix = G__20884;
remainder = G__20885;
continue;
} else {
var G__20886 = cljs.core.conj.call(null,suffix,curr);
var G__20887 = cljs.core.rest.call(null,remainder);
suffix = G__20886;
remainder = G__20887;
continue;
}
...
var vec__20888 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20888,(0),null);
var path = cljs.core.nth.call(null,vec__20888,(1),null);
var post_path = cljs.core.nth.call(null,vec__20888,(2),null);
...
var vec__20891 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20891,(0),null);
var path = cljs.core.nth.call(null,vec__20891,(1),null);
var post_path = cljs.core.nth.call(null,vec__20891,(2),null);
