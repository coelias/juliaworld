...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__16970_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__16970_SHARP_),cljs.core.second.call(null,p1__16970_SHARP_));
}),cljs.core.map.call(null,(function (p1__16971_SHARP_,p2__16972_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__16971_SHARP_,p2__16972_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__16973 = cljs.core.first.call(null,path_pieces);
switch (G__16973) {
case "":
...
var G__16975 = cljs.core.first.call(null,path_pieces);
...
var G__16977 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__16977)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__16977)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__16977)){
return path_pieces;
} else {
...
var curr = first__16986;
var remainder = seq__16985__$1;
var pred__16987 = cljs.core._EQ_;
var expr__16988 = curr;
if(cljs.core.truth_(pred__16987.call(null,null,expr__16988))){
return result;
} else {
if(cljs.core.truth_(pred__16987.call(null,"",expr__16988))){
var G__16990 = result;
var G__16991 = remainder;
result = G__16990;
remaining_path = G__16991;
continue;
} else {
if(cljs.core.truth_(pred__16987.call(null,".",expr__16988))){
var G__16992 = result;
var G__16993 = remainder;
result = G__16992;
remaining_path = G__16993;
continue;
} else {
if(cljs.core.truth_(pred__16987.call(null,"..",expr__16988))){
var G__16994 = pathetic.core.up_dir.call(null,result);
var G__16995 = remainder;
result = G__16994;
remaining_path = G__16995;
continue;
} else {
var G__16996 = cljs.core.conj.call(null,result,curr);
var G__16997 = remainder;
result = G__16996;
remaining_path = G__16997;
continue;
}
}
}
...
var pred__17001 = cljs.core._EQ_;
var expr__17002 = curr;
if(cljs.core.truth_(pred__17001.call(null,null,expr__17002))){
return suffix;
} else {
if(cljs.core.truth_(pred__17001.call(null,"",expr__17002))){
var G__17004 = suffix;
var G__17005 = cljs.core.rest.call(null,remainder);
suffix = G__17004;
remainder = G__17005;
continue;
} else {
if(cljs.core.truth_(pred__17001.call(null,".",expr__17002))){
var G__17006 = suffix;
var G__17007 = cljs.core.rest.call(null,remainder);
suffix = G__17006;
remainder = G__17007;
continue;
} else {
if(cljs.core.truth_(pred__17001.call(null,"..",expr__17002))){
var G__17008 = cljs.core.conj.call(null,suffix,"..");
var G__17009 = cljs.core.rest.call(null,remainder);
suffix = G__17008;
remainder = G__17009;
continue;
} else {
var G__17010 = cljs.core.conj.call(null,suffix,curr);
var G__17011 = cljs.core.rest.call(null,remainder);
suffix = G__17010;
remainder = G__17011;
continue;
}
...
var vec__17012 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__17012,(0),null);
var path = cljs.core.nth.call(null,vec__17012,(1),null);
var post_path = cljs.core.nth.call(null,vec__17012,(2),null);
...
var vec__17015 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__17015,(0),null);
var path = cljs.core.nth.call(null,vec__17015,(1),null);
var post_path = cljs.core.nth.call(null,vec__17015,(2),null);
