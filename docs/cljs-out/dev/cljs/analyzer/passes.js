...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__24401_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__24401_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__24404 = ast;
if((G__24404 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__24404,passes,opts);
}
