...
var digit_25503 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_25504__$1 = (vlq >>> (5));
while(true){
if((vlq_25504__$1 > (0))){
var digit_25505__$1 = (digit_25503 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_25505__$1));

var G__25506 = (vlq_25504__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__25507 = (vlq_25504__$1 >>> (5));
digit_25503 = G__25506;
vlq_25504__$1 = G__25507;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_25503));
}
break;
}
...
var G__25508 = i__$1;
var G__25509 = result__$1;
var G__25510 = shift__$1;
i = G__25508;
result = G__25509;
shift = G__25510;
continue;
