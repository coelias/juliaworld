...
var digit_11552 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_11553__$1 = (vlq >>> (5));
while(true){
if((vlq_11553__$1 > (0))){
var digit_11554__$1 = (digit_11552 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_11554__$1));

var G__11555 = (vlq_11553__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__11556 = (vlq_11553__$1 >>> (5));
digit_11552 = G__11555;
vlq_11553__$1 = G__11556;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_11552));
}
break;
}
