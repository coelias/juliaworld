...
return cljs.core.filter.call(null,new cljs.core.Keyword(null,"visible","visible",-1024216805),cljs.core.filter.call(null,cljs.core.map_QMARK_,cljs.core.map.call(null,(function (p1__21601_SHARP_){
return cljs.core.get.call(null,p1__21601_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null));
}),cljs.core.map.call(null,(function (p__21602){
var vec__21603 = p__21602;
var ly_name = cljs.core.nth.call(null,vec__21603,(0),null);
var map__21606 = cljs.core.nth.call(null,vec__21603,(1),null);
var map__21606__$1 = cljs.core.__destructure_map.call(null,map__21606);
var items = cljs.core.get.call(null,map__21606__$1,new cljs.core.Keyword(null,"items","items",1031954938));
if(cljs.core.truth_(items)){
return cljs.core.update_vals.call(null,items,(function (p1__21600_SHARP_){
return cljs.core.merge.call(null,p1__21600_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer","layer",-1601820589),ly_name,new cljs.core.Keyword(null,"position","position",-2011731912),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null)], null));
}));
} else {
return null;
}
...
var map__21607 = cljs.core.get_in.call(null,cljs.core.deref.call(null,juliaworld.state.game),path);
var map__21607__$1 = cljs.core.__destructure_map.call(null,map__21607);
var sprite = cljs.core.get.call(null,map__21607__$1,new cljs.core.Keyword(null,"sprite","sprite",172516848));
...
return cljs.core.reset_BANG_.call(null,juliaworld.state.game,clojure.walk.postwalk.call(null,(function (p1__21608_SHARP_){
if(((cljs.core.contains_QMARK_.call(null,p1__21608_SHARP_,new cljs.core.Keyword(null,"visible","visible",-1024216805))) && (cljs.core.contains_QMARK_.call(null,p1__21608_SHARP_,new cljs.core.Keyword(null,"action","action",-811238024))))){
(new cljs.core.Keyword(null,"sprite","sprite",172516848).cljs$core$IFn$_invoke$arity$1(p1__21608_SHARP_).visible = true);

return cljs.core.assoc.call(null,p1__21608_SHARP_,new cljs.core.Keyword(null,"visible","visible",-1024216805),true);
} else {
return p1__21608_SHARP_;
}
...
var map__21609 = cljs.core.deref.call(null,juliaworld.state.game);
var map__21609__$1 = cljs.core.__destructure_map.call(null,map__21609);
var map__21610 = cljs.core.get.call(null,map__21609__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var map__21610__$1 = cljs.core.__destructure_map.call(null,map__21610);
var score = cljs.core.get.call(null,map__21610__$1,new cljs.core.Keyword(null,"score","score",-1963588780));
var final_score = cljs.core.get.call(null,map__21610__$1,new cljs.core.Keyword(null,"final-score","final-score",-1149434122));
...
var map__21611 = cljs.core.get.call(null,new cljs.core.Keyword(null,"sprites","sprites",-1835833922).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,juliaworld.state.game)),id);
var map__21611__$1 = cljs.core.__destructure_map.call(null,map__21611);
var type = cljs.core.get.call(null,map__21611__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var properties = cljs.core.get.call(null,map__21611__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var vec__21613 = juliaworld.state.get_config.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"screen-block-res","screen-block-res",-1934351900)], null));
var xb = cljs.core.nth.call(null,vec__21613,(0),null);
var yb = cljs.core.nth.call(null,vec__21613,(1),null);
var pos = ((xb * y) + x);
var $ = layers;
...
var $__$3 = cljs.core.map.call(null,(function (p1__21612_SHARP_){
return cljs.core.nth.call(null,p1__21612_SHARP_,pos);
}),$__$2);
