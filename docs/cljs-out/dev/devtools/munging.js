...
var o31109 = temp__5802__auto__;
var temp__5802__auto____$1 = (o31109["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o31110 = temp__5802__auto____$1;
return (o31110["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30467__auto__ = f;
return (o__30467__auto__["toString"]).call(o__30467__auto__);
} else {
return "";
}
}catch (e31111){var _ = e31111;
return "";
}});
...
try{var o__30467__auto___31113 = t;
(o__30467__auto___31113["cljs$lang$ctorPrWriter"]).call(o__30467__auto___31113,t,writer);
}catch (e31112){var __31114 = e31112;
}
...
var char_code = (function (){var o__30467__auto__ = (new String(char$));
return (o__30467__auto__["charCodeAt"]).call(o__30467__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30467__auto__ = String;
return (o__30467__auto__["fromCharCode"]).call(o__30467__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31115 = num_code;
switch (G__31115) {
case (1):
return (185);
...
var o__30467__auto__ = String;
return (o__30467__auto__["fromCharCode"]).call(o__30467__auto__,superscript_code);
});
/**
...
}catch (e31117){var _e__30474__auto__ = e31117;
return false;
}})())){
...
var vec__31118 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31118,(0),null);
...
var len__5766__auto___31127 = arguments.length;
var i__5767__auto___31128 = (0);
while(true){
if((i__5767__auto___31128 < len__5766__auto___31127)){
args__5772__auto__.push((arguments[i__5767__auto___31128]));

var G__31129 = (i__5767__auto___31128 + (1));
i__5767__auto___31128 = G__31129;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31123){
var vec__31124 = p__31123;
var ns_detector = cljs.core.nth.call(null,vec__31124,(0),null);
...
var G__31130 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31131 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31130;
remaining_tokens = G__31131;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31121){
var G__31122 = cljs.core.first.call(null,seq31121);
var seq31121__$1 = cljs.core.next.call(null,seq31121);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31122,seq31121__$1);
}));
...
var vec__31135 = cljs.core.split_with.call(null,(function (p1__31134_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31134_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31135,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31135,(1),null);
...
var vec__31141 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31141,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31141,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31144 = cljs.core.rest.call(null,remaining_tokens);
var G__31145 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31144;
name_tokens = G__31145;
continue;
} else {
...
var vec__31148 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31148,(0),null);
var arity = cljs.core.nth.call(null,vec__31148,(1),null);
var vec__31151 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31151,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31151,(1),null);
var vec__31154 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31154,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31154,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31154,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31154,(3),null);
...
var vec__31160 = result;
var munged_ns = cljs.core.nth.call(null,vec__31160,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__31160,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__31160,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__31160,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__31160,(4),null);
var arity = cljs.core.nth.call(null,vec__31160,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__31164 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__31164,(0),null);
var args = cljs.core.nth.call(null,vec__31164,(1),null);
var vec__31167 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__31167,(0),null);
var name = cljs.core.nth.call(null,vec__31167,(1),null);
...
var G__31170 = (arity + (1));
var G__31171 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31172){
var vec__31173 = p__31172;
var arity = cljs.core.nth.call(null,vec__31173,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__31173,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__31176_SHARP_){
return cljs.core.get.call(null,arities,p1__31176_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__31177_SHARP_){
return cljs.core.drop.call(null,(2),p1__31177_SHARP_);
}),sorted_infos);
...
var args__5772__auto__ = [];
var len__5766__auto___31184 = arguments.length;
var i__5767__auto___31185 = (0);
while(true){
if((i__5767__auto___31185 < len__5766__auto___31184)){
args__5772__auto__.push((arguments[i__5767__auto___31185]));

var G__31186 = (i__5767__auto___31185 + (1));
i__5767__auto___31185 = G__31186;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31180){
var vec__31181 = p__31180;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__31181,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31178){
...
var G__31187 = arg;
var G__31187__$1 = (((G__31187 instanceof cljs.core.Keyword))?G__31187.fqn:null);
switch (G__31187__$1) {
...
var map__31189__$1 = cljs.core.__destructure_map.call(null,map__31189);
var include_ns_QMARK_ = cljs.core.get.call(null,map__31189__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__31189__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__31189__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__31189__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31190 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__31190,(0),null);
var fn_name = cljs.core.nth.call(null,vec__31190,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__31190,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__31190,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__31190,(4),null);
var arity = cljs.core.nth.call(null,vec__31190,(5),null);
...
var o__30467__auto__ = f;
return (o__30467__auto__["getBasis"]).call(o__30467__auto__);
});
/**
...
}catch (e31193){var _e__30474__auto__ = e31193;
...
var G__31194 = (obj[cljs.core.first.call(null,path)]);
var G__31195 = cljs.core.rest.call(null,path);
obj = G__31194;
path = G__31195;
continue;
} else {
...
var _STAR_ = (function (accum,p__31196){
var vec__31197 = p__31196;
var bit = cljs.core.nth.call(null,vec__31197,(0),null);
var protocol = cljs.core.nth.call(null,vec__31197,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31200){
var vec__31201 = p__31200;
var ns = cljs.core.nth.call(null,vec__31201,(0),null);
var name = cljs.core.nth.call(null,vec__31201,(1),null);
var selector = cljs.core.nth.call(null,vec__31201,(2),null);
...
var post_process = (function (p__31205){
var vec__31206 = p__31205;
var munged_name = cljs.core.nth.call(null,vec__31206,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__31206,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__31204_SHARP_){
return (obj[cljs.core.first.call(null,p1__31204_SHARP_)]);
}),sorted_matches);
