...
var G__34407 = devtools.prefs.pref.call(null,v);
v = G__34407;
continue;
} else {
return v;
...
}catch (e34408){var _e__33666__auto__ = e34408;
return false;
}})();
...
}catch (e34410){var _e__33666__auto__ = e34410;
return false;
}})();
...
}catch (e34412){var _e__33666__auto__ = e34412;
return false;
}}
}
});
...
var vec__34414 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__34414,(0),null);
var name = cljs.core.nth.call(null,vec__34414,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__34417_SHARP_);
}),template);
});
