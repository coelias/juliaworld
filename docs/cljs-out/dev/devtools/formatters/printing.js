...
var len__5766__auto___34455 = arguments.length;
var i__5767__auto___34456 = (0);
while(true){
if((i__5767__auto___34456 < len__5766__auto___34455)){
args__5772__auto__.push((arguments[i__5767__auto___34456]));

var G__34457 = (i__5767__auto___34456 + (1));
i__5767__auto___34456 = G__34457;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq34452){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34453,G__34454,seq34452__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__34458_SHARP_){
return (!((cljs.core.meta.call(null,p1__34458_SHARP_) == null)));
})))){
...
var map__34459 = opts;
var map__34459__$1 = cljs.core.__destructure_map.call(null,map__34459);
var markup_db = cljs.core.get.call(null,map__34459__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e34460){var _e__33666__auto__ = e34460;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e34462){var _e__33666__auto__ = e34462;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__34464 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__34465 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__34465);
...
var markup_db = cljs.core.get.call(null,map__34466__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__34464);
}});
...
var temp__5802__auto___34470 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___34470)){
var managed_print_level_34471 = temp__5802__auto___34470;
var _STAR_print_level_STAR__orig_val__34468_34472 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__34469_34473 = managed_print_level_34471;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__34469_34473);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__34467_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__34467_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__34468_34472);
}} else {
job_fn.call(null);
}
