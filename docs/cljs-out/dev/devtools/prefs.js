...
if(cljs.core.truth_(devtools.prefs.goog$module$goog$labs$userAgent$browser.isFirefox.call(null))){
return cljs.core.deref.call(null,devtools.defaults.firefox_overrides_config);
} else {
return null;
}
}),null));
...
return cljs.core.merge.call(null,cljs.core.deref.call(null,devtools.prefs.default_config),cljs.core.deref.call(null,devtools.prefs.firefox_overrides_config),cljs.core.deref.call(null,devtools.prefs.external_config));
}),null));
...
var len__5766__auto___34258 = arguments.length;
var i__5767__auto___34259 = (0);
while(true){
if((i__5767__auto___34259 < len__5766__auto___34258)){
args__5772__auto__.push((arguments[i__5767__auto___34259]));

var G__34260 = (i__5767__auto___34259 + (1));
i__5767__auto___34259 = G__34260;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.prefs.update_pref_BANG_.cljs$lang$applyTo = (function (seq34255){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34256,G__34257,seq34255__$2);
}));
