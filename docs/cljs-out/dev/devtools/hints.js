...
var line = cljs.core.get.call(null,map__35077__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__35077__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e35076){var _e = e35076;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___35078 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___35078)){
var seen_errors_35079 = temp__5802__auto___35078;
if(cljs.core.truth_(seen_errors_35079.has(self))){
} else {
seen_errors_35079.add(self);

var temp__5804__auto___35080 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___35080)){
var sense_35081 = temp__5804__auto___35080;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_35081)].join(''));
} else {
}
}
} else {
